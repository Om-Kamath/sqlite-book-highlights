...
from books import *
import sign_up
from properties import BUTTON_FONT, ERROR_FONT, HEADER, LABEL_FONT, LINK_FONT, BACKGROUND_COLOR, BUTTON_COLOR, UNDERLINE_COLOR
...
class SignIn:
    def __init__(self):
        ...
        self.white_frame = Frame(
            self.root, bg="white", width=290, height=290).place(x=25, y=25)
        ...
        self.email_input_area = Entry(
            self.root, width=20, borderwidth=5, font=LABEL_FONT, relief=FLAT)
        ...
        self.user_pass_input_area = Entry(
            self.root, width=20, borderwidth=5, font=LABEL_FONT, relief=FLAT, show="\u25CF")
        ...
        Frame(self.root, width=165, height=2, bg=UNDERLINE_COLOR).place(x=140, y=125)
        Frame(self.root, width=165, height=2, bg=UNDERLINE_COLOR).place(x=140, y=165)
